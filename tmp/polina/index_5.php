...
<!--Основной контент (статья)-->
    <div id="content">
<?php 	 if (isset($_SESSION['login'])) echo 'Добро пожаловать, ' . $_SESSION['login']; ?> 
    <p><a href="logout.php" 'button class= btn btn-lg btn-primary btn-block' type='sumbit' >Выход</a></p>  
